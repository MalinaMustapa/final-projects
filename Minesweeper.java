...
class Minesweeper extends JFrame implements ActionListener, ContainerListener {
    ...
    public void setpanel(int level, int setr, int setc, int setm) {
        ...
        tf_time.setForeground(Color.RED); // stopwatch
    ...
    public void setmanue() {
        ...
        helpitem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "1. Select a difficulty level from GAME\n"
                		+ "2. The number of the upper-left indicates the number of mines\n"
                		+ "3. The number in the upper-right corner is the timer\n"
                		+ "4. Click any square randomly\n"
                		+ "5. The number generated indicates the number of mines touching the square\n"
                		+ "6. Click known safe squares\n"
                		+ "7. Right-click the identified squares that contain mines to flag them\n"
                		+ "8. You can reset the game anytime you want\n");
